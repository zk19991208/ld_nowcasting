...
from metrics import add_score_log, add_time_score_log, add_score_log_sum
...
class PhyDNet_ATT(pl.LightningModule):
    ...
    def __init__(self, height, width, input_length, target_length, downscale_factor, learning_rate, loss_fx,
        ...
        super(PhyDNet_ATT, self).__init__()
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = self.hparams.param_a * input_loss + self.hparams.param_b * target_loss \
               ...
               + self.hparams.param_d * constraints_loss_decoder / self.hparams.rnn_input_dim
    ...
    def add_model_specific_args(parent_parser):
        parser = parent_parser.add_argument_group("PhyDNet_ATT")
        add_parser(parser)
        ...
        parser.add_argument('--sampling_changing_rate_epoch', type=float, default=0.1)
...
if __name__ == "__main__":
    ...
    parser = PhyDNet_ATT.add_model_specific_args(parser)
    args = parser.parse_args()
    dict_args = vars(args)
    m = PhyDNet_ATT(**dict_args)
