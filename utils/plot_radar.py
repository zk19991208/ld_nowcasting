...
prov_shp = shpreader.Reader(r"/home/zhuangxr/work/zengkang/map/bou2_4l.shp")
city_shp = shpreader.Reader("/home/zhuangxr/work/zengkang/map/city.shp")
...
def main(model):
    if model == 'single':
        ...
        pool = mp.Pool(4)
        files_dir = "/home/zhuangxr/work/zengkang/save/inference/Radar"
